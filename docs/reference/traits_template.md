...
- **Nome**: etichetta leggibile; preferire le voci approvate in [`docs/reference/trait_reference.md`](catalog/trait_reference.md).
- **Descrizione**: contesto e significato; riusa descrizioni approvate in [`docs/reference/trait_reference.md`](catalog/trait_reference.md).
